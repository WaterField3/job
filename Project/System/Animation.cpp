...
#pragma pack(push,8)
	...
	static_assert(sizeof(DX::AnimationSDKMESH::SDKANIMATION_FRAME_DATA) == 112, "SDK Mesh structure size incorrect");
...
DX::AnimationSDKMESH::SDKANIMATION_FRAME_DATA& DX::AnimationSDKMESH::GetFrameData(const DirectX::Model& model, size_t nbones, std::string boneName)
{
	assert(m_animData && m_animSize > 0);
