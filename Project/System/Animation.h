...
namespace DX
{
	...
	public:
		...
		SDKANIMATION_FRAME_DATA& GetAnimationFrameData(const DirectX::Model& model, size_t nbones, std::string boneName);

		SDKANIMATION_DATA& GetAnimationData(const DirectX::Model& model, size_t nbones, std::string boneName);
