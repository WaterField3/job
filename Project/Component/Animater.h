...
namespace TMF
{
	...
	public:
		...
		void SetFileName(std::string fileName, float endTime, float animSpeed, float animStopTime);
		void LoadAnimation();
	...
	private:
		...
		float m_nextAnimEnd = 0.0f;
		float m_animStopTime = 0.0f;
		float m_animStopEndTime = 0.0f;
