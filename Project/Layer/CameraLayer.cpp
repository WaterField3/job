...
void TMF::CameraLayer::SetName(const char name[64])
{
	m_name = name;
}

const DirectX::XMFLOAT3 TMF::CameraLayer::GetTransform(const char name[32])
{
	if (name == "rotation")
	{
		return m_rotation;
...
const char* TMF::CameraLayer::GetName()
{
	return m_name;
}
